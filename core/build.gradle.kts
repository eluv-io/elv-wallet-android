...
dependencies {
    ...
    // navigation-common provides NavType, which :core uses to expose serializable NavType helpers
    // for routes shared between :tv (Compose) and :mobile (Fragment) — both pull in heavier
    // navigation-* artifacts that depend on navigation-common.
