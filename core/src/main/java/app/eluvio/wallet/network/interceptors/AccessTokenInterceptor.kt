...
class AccessTokenInterceptor @Inject constructor(
    ...
    private val userAgent = if (appInfo.isDebug) {
        // Don't use "androidtv" in debug build, to bypass eligible-tenants filtering by backend.
        "android-debug_v${appInfo.versionName}"
    } else {
        "AndroidTV/${Build.VERSION.RELEASE} (api:${Build.VERSION.SDK_INT}; ${appInfo.applicationId}:${appInfo.versionName}_${appInfo.versionCode}; ${Build.MANUFACTURER}; ${Build.MODEL}; ${Build.DEVICE})"
    }
