...
class ProfileViewModel @Inject constructor(
    ...
    override fun onResume() {
        ...
        Flowable.combineLatest(
            ...
            tokenStore.userEmail.observe(),
        ) { env, config, walletAddress, stagingFlag, tokenExpiration, email ->
            ...
            State(
                ...
                email = email.orDefault(null)?.takeIf { it.isNotBlank() },
                network = env,
                ...
                appVersion = "${appInfo.versionName} (${appInfo.versionCode})",
