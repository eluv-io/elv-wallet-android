...
class PropertyDetailViewModel @Inject constructor(
    ...
    private val navArgs: PropertyDetailNavArgs,
    ...
    override fun onResume() {
        ...
        updateState { copy(searchNavigationEvent = NavTarget.PropertySearch(propertyId).asPush()) }
                ...
                onError = { exception ->
                    when (exception) {
                        is ShowPurchaseOptionsRedirectException -> {
                            ...
                            navigateTo(NavTarget.PurchasePrompt(exception.permissionContext).asReplace())
                        }
