...
dependencies {
    ...
    // nav3-hilt-vm — annotation classes come transitively via :core's api dep, but the KSP
    // processor must be applied per-module that has annotated VMs.
    ...
    // Navigation 3 — :core already exposes navigation3-runtime + lifecycle-viewmodel-navigation3
    // transitively; :mobile hosts the NavDisplay so it needs navigation3-ui directly.
